...
![Menu principal com as opções de login e criação de usuário](menuprincipal.png)
...
![Criação de usuário com mensagens de erro](criacaousuario.png)
...
![Tentativas de login com mensagens de errp](login.png)

### Menu logado

Após realizar o login, o sistema lhe apresentará o menu de "logado", onde você se deparará com as seguintes opções:

![Menu logado apresentando as opções disponíveis](menulogado.png)
...
![Criação de post](criacaopost.png)
...
![Visualização do perfil do usuário logado](vermeuperfil.png)
...
![Ver posts do usuário logado](verposts.png)
...
![Tela mostrando a edição de post](editarpost.png)
...
![Mensagem de post deletado](deletarpost.png)
...
![Tela de amigos, juntamente com a opção de remover amizade](veramigos.png)
...
![Tela de edição de usuário](editarusuario.png)
...
![Tela de pesquisa de usuários](buscarusuarios.png)
...
![Tela do feed de notícias](feednoticias.png)
